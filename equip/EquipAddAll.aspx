    ...
    <asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <script src="/Scripts/HRSProjectScript.js"></script>
                ...
                <div class="card-body table-responsive table-sm">
                    <div id="divsearch" runat="server" class="row">
                        ...
                        <div class="input-group">
                            <asp:DropDownList ID="ddlserchToll" runat="server" CssClass="col-2 dropdown dropdown-item"></asp:DropDownList>
                            <asp:Button ID="btnsearchAdd" runat="server" Text="ค้นหา" 
                                CssClass="btn btn-outline-secondary" OnClick="btnsearchAdd_Click" />
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding-left: 20px">
                        <asp:Label ID="titlegrid" runat="server" Text="" Visible="false" Font-Bold="true"
            ...
            <div class="card">
                <div class="card-header ">
                    <div class="card-title">
                        <asp:Label ID="Label1" runat="server" Text="รายการครุภัณฑ์นำเข้าระบบ"></asp:Label>
                    </div>
                </div>
                <div class="card-body ">
                    <asp:Panel ID="Panel1" runat="server">
                        ...
                        DataKeyNames="NewEQ_id"
                            ...
                            OnPageIndexChanging="GridAddAll_PageIndexChanging"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="แก้ไข" HeaderStyle-CssClass="text-center" 
                                    >
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbtneditAdd" runat="server"
