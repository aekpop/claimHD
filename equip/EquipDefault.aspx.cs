...
namespace ClaimProject.equip
{
    public partial class EquipDefault : System.Web.UI.Page
    {
        ...
        protected void loadingpage()
        {
            ...
            string sqleqrt4 = "SELECT COUNT(*) AS numqt FROM tbl_transfer LEFT JOIN tbl_transfer_action ON tbl_transfer.trans_id = tbl_transfer_action.transfer_id WHERE ( num_success = 'NotRepair' OR num_success = 'repaired' ) AND ( tbl_transfer.toll_send = '" + sqltran + "' ) AND tbl_transfer.trans_stat = " + sqlStatus + " ";
