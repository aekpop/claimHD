              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">อุบัติเหตุ (Monthly)</div>
                     ...
                     <div class="col-auto">
                          <asp:Label ID="lbClaimStatMonthly" runat="server" Font-Bold="true" CssClass="text-gray"></asp:Label>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">อุบัติเหตุ (Budget)</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-calendar fa-2x text-gray-300">
                           <asp:Label ID="lbClaimStatBudget" runat="server" Text=""></asp:Label>
                      </i>
                    </div>
                  </div>
                </div>
              ...
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">อุบัติเหตุ (Overall)</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-bootstrap fa-2x text-gray-300"></i>
                    </div>
                  </div>
                    <div class="col-auto">
                          <asp:Label ID="lbClaimStatOverall" runat="server" Font-Bold="true" CssClass="text-gray"></asp:Label>
                      </div>
                </div>
              </div>
            </div>
