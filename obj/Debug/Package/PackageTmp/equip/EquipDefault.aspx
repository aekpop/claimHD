                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table table-sm table-hover">
                                                <tbody>
                                                    ...
                                                    <tr class="">
                                                        <th scope="row" class="text-center"></th>
                                                        <td class="text-nowrap" style="font-size: 15px; font-family: 'Prompt', sans-serif;">ใช้งานปกติ</td>
                                                        <td class="text-nowrap" style="font-size: 15px; font-family: 'Prompt', sans-serif;">
                                                    ...
                                                    <tr class="">
                                                        <th scope="row" class="text-center"></th>
                                                        <td class="text-nowrap" style="font-size: 15px; font-family: 'Prompt', sans-serif;">ชำรุด</td>
                                                        <td class="text-nowrap" style="font-size: 15px; font-family: 'Prompt', sans-serif;">
                                            ...
                                            <table class="table table-sm table-hover">
                                                <tbody>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="text-nowrap" style="font-size: 15px; font-family: 'Prompt', sans-serif;">
                                                            <asp:Label ID="lbStaSentToll" runat="server"></asp:Label>
                                                            /
                                                            <asp:Label ID="lbeqSentToll" runat="server"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr class="">
                                                        <th scope="row" class="text-center"></th>
                                                        ...
                                                        <td class="text-nowrap" style="font-size: 15px; font-family: 'Prompt', sans-serif;">
                                                            <asp:Label ID="lbStaClaimToll" runat="server"></asp:Label>
                                                            /
                                                            <asp:Label ID="lbeqClaimToll" runat="server"></asp:Label>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
