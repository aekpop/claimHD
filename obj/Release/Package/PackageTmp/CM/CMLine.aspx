...
<body>
    <form id="form1" runat="server" style="font-family: 'TH SarabunPSK'">
        <div class="card" style="z-index: 0; font-family: Prompt">
            ...
            <asp:GridView ID="gridCMLine" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="ช่องทาง" ControlStyle-Width="120px" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center">
                        <ItemTemplate>
                            <asp:Label ID="lbChannel" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.locate_name") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="อุปกรณ์" ControlStyle-Width="300px" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center">
                        <ItemTemplate>
        ...
        <script src="/Scripts/bulma-calendar.min.js"></script>
