<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PM71Report.aspx.cs" Inherits="ClaimProject.PM.Report.PM71Report" %>
...
<body style="font-family: 'THSarabun,THSarabunIT๙'">
    <form id="form1" runat="server">
        <div id="dvReport">
            ...
            <CR:CrystalReportViewer ID="CRT71" runat="server" EnableParameterPrompt="False" 
